...
public class InventoryHistoryAdapter extends RecyclerView.Adapter<InventoryHistoryAdapter.MyViewHolder>
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private InventoryHistoryAdapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final InventoryHistoryAdapter.ClickListener clickListener) {
