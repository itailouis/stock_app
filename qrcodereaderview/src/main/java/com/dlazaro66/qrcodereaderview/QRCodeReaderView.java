...
public class QRCodeReaderView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public interface OnQRCodeReadListener {
        void onQRCodeRead(Result result, PointF[] points);
    }
    ...
    public QRCodeReaderView(Context context, AttributeSet attrs) {
        ...
        hints.put(DecodeHintType.POSSIBLE_FORMATS, PRODUCT_FORMATS);
        hints.put(DecodeHintType.NEED_RESULT_POINT_CALLBACK, new ResultPointCallback() {
            @Override
            public void foundPossibleResultPoint(ResultPoint resultPoint) {
                Log.e(TAG, "foundPossibleResultPoint(ResultPoint resultPoint)");
                //mOnQRCodeReadListener.onQRCodeRead("data found", new PointF[]{new PointF(8,9)});
            }
        });
        if (isInEditMode()) {
            return;
    ...
    private static class DecodeFrameTask extends AsyncTask<byte[], Void, Result> {
        ...
        protected Result doInBackground(byte[]... params) {
            ...
            final PlanarYUVLuminanceSource source = view.mCameraManager.buildLuminanceSource(rotatedData, view.mPreviewHeight, view.mPreviewWidth);
            ...
            try {
                ...
                Log.d(TAG, "No QR Code found"+e.getMessage());
            } finally {
        ...
        protected void onPostExecute(Result result) {
            ...
            if (view != null && result != null && view.mOnQRCodeReadListener != null) {
                ...
                view.mOnQRCodeReadListener.onQRCodeRead(result, transformedPoints);
            }
        }
